...
df <- left_join(UseCode, df, by=("UseCode"))
...
```{r}
dbWriteTable(db, "Parcel", df, overwrite = TRUE)
```
...
#Now I have a database with joined file, but i joined UseCodes and Parcels in R.....
